  ...
  return (
    <div className="">
      <section className="container mx-auto p-4 md:px-10 lg:px-20 lg:py-10 w-full space-y-6 lg:space-y-20">
        ...
        <div className="flex flex-col lg:flex-row items-center shadow-2xl shadow-[#0000001a] overflow-hidden">
          ...
          <div className="director-detail-container mx-auto text-center md:text-left p-5 lg:w-1/2">
            <div className="p-5 lg:p-0 space-y-6 md:space-y-6">
              ...
              <Link to="/about" className="inline-flex items-center justify-center px-10 py-4 bg-[#0075B3] text-white font-campton">Read More</Link>
            </div>
          </div>
        </div>
      </section>
