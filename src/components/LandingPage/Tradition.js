...
const Tradition = () => {
  return (
    <section className="p-4 py-16 md:p-10 lg:px-20 lg:py-20 container mx-auto lg:pb-36 2xl:pb-60 space-y-10">
      <p className="text-3xl md:text-4xl lg:text-[60px] lg:w-[70%] font-bold" style={{lineHeight: "105%"}} data-aos="fade-up">
      ...
      <div className="flex flex-col space-y-9 lg:w-1/2 font-inter ">
        <div className="flex flex-wrap gap-10">
          <div className="md:w-[45%] space-y-4" data-aos="fade-up" data-aos-delay="50">
