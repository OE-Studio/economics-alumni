      ...
      <div className="container mx-auto p-4 py-16 mt-10 md:p-10 lg:p-16">
        <div className="space-y-6">
          ...
          <div className="flex flex-col lg:w-8/12 justify-between lg:flex-row space-y-6 lg:space-y-0">
            <p className="text-base md:text-lg text-gray-800 lg:w-7/12 text-center lg:text-left">
              Past events, organised workshops, and strategic meetings,
              trainings and classes
            </p>
            {location[1] !== "gallery" && (
              <button className="bg-[#0075B3] p-4 text-white">
                View full gallery
              </button>
            )}
          </div>
