            ...
            <div className="flex flex-col justify-between lg:items-center  space-y-4 lg:space-y-10">
                <div className="flex flex-col items-center space-y-6 lg:space-y-10">
                    <p className=" text-3xl md:text-5xl lg:text-[80px]  font-bold leading-12 text-center  w-[85%]">
                        See our gallery</p>
                    <p className="md:text-xl lg:text-xl font-medium leading-7 lg:leading-9 text-center  lg:w-[60%] w-[85%]">
                    ...
                    <a href="#gallery-container" className="inline-flex space-x-4 items-center justify-start py-4 pl-5 pr-3.5 border rounded-full border-blue-800 border-opacity-95 font-campton cursor-pointer">
                        <p className="text-base font-semibold text-opacity-95">Explore our gallery below</p>
